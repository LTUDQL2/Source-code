...
namespace Project.DAO
{
    public class ChiTietPhieu_DAO
    {
        public static DataTable gettable(string MaPhieu)
        {
            ...
            cmd.CommandText = "ChiTietPhieuNhap_select";
        ...
        public static DataTable gettable2(string MaPhieu)
        {
            ...
            conn.Open();
            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = "ChiTietPhieuNhap_select2";
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Connection = conn;
            SqlParameter para = new SqlParameter("@MaPhieu", SqlDbType.NChar, 10);
            para.Direction = ParameterDirection.Input;
        ...
        {
            List<ChiTietPhieu_DTO> ls = new List<ChiTietPhieu_DTO>();
            SqlConnection conn = new SqlConnection(DataProvider.GetConnString());
            conn.Open();
            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = "ChiTietPhieuNhap_select";
            ...
            while (cusor.Read())
            {
                ChiTietPhieu_DTO da = new ChiTietPhieu_DTO();
        ...
        public static void themchitiet(ChiTietPhieu_DTO phieu)
        {
            SqlConnection conn = new SqlConnection(DataProvider.GetConnString());
            conn.Open();
            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = "ChiTietPhieuNhap_insert";
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Connection = conn;
            SqlParameter para = new SqlParameter("@MaPhieu", SqlDbType.NChar, 10);
            para.Direction = ParameterDirection.Input;
        ...
        public static void capnhatchitiet(ChiTietPhieu_DTO phieu)
        {
            SqlConnection conn = new SqlConnection(DataProvider.GetConnString());
            conn.Open();
            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = "ChiTietPhieuNhap_update";
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Connection = conn;
            SqlParameter para = new SqlParameter("@MaPhieu", SqlDbType.NChar, 10);
            para.Direction = ParameterDirection.Input;
        ...
        public static void xoaphieunhap(int ID, string Maphieu)
        {
            SqlConnection conn = new SqlConnection(DataProvider.GetConnString());
            conn.Open();
            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = "ChiTietPhieuNhap_delete";
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Connection = conn;
